...
(
	...
	// three terms of doubleSidedDisk below, and only one - it says nothing
	// on its own about the geometry of the volume inside the file, which
	// was this core's original mistake (FLOPPY_WRITE_PLAN.md Phase 7).
	input img800k,
	...
	// ---------------------------------------------------------------------
	// Is this a double-sided diskette? (Phase 7 of FLOPPY_WRITE_PLAN.md)
	//
