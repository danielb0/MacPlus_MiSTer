// floppy_sd_writer.v
//
// Phase 4 of FLOPPY_WRITE_PLAN.md: persist a checksum-valid, SDRAM-
...
//
// A checksum-valid sector never depends on rotational position (see
// finding 1.5 in the plan), so this module has no notion of "gap" either
