// cd_mix.v -- Phase 3C/3D: reclaim the Mac channel's headroom, then sum the
// CD-DA pair into it. See SCSI_UPGRADE_PLAN.md 3C and 3D.
//
...
//
// NOTE the plan text suggested cd_audio.sv's `disc_audio` for this. It is the
...
module cd_mix (
	...
	// already-wrapped value -- Quartus flags it (warning 10259) and the plan's
	// own snippet in SCSI_UPGRADE_PLAN.md 3D has the same bug. 16'sh8000 IS
